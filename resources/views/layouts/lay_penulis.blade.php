      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="/assets/AdminLTE-master/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link @yield('menu_artikel')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./" class="nav-link @yield('menu_sub_tulis')">
              ...
              <li class="nav-item">
                <a href="./semua-artikel" class="nav-link @yield('menu_sub_semua')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Semua Artikel</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="./publish" class="nav-link @yield('menu_sub_publish')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Publish</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./draft" class="nav-link @yield('menu_sub_draft')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Draft</p>
                </a>
              </li>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link @yield('menu_kategori')">
                            <i class="nav-icon fas fa-cat"></i>
                            <p>
                            Kategori
                              <i class="right fas fa-angle-left"></i>
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="./menusemuakategori" class="nav-link @yield('menu_sub_kategori')">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Semua Kategori</p>
                                </a>
                              </li>
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="./menukategori" class="nav-link @yield('menu_kategoriform')">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Kategori</p>
                                </a>
                              </li>
